...
require "happymapper"
require "iso/std/iso/v20022/tech/xsd/pain001001/organisation_identification_scheme_name1_choice"
...
class GenericOrganisationIdentification1 
  ...
  tag "GenericOrganisationIdentification1"

    
    element :id, String, :tag => "Id", :namespace => "ns1"
    
    has_one :schme_nm, Iso::Std::Iso::V20022::Tech::Xsd::Pain001001::OrganisationIdentificationSchemeName1Choice, :tag => "SchmeNm", :namespace => "ns1"
